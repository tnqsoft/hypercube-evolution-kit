...
#undef en
...
#ifndef WELCOME_MSG
  #define WELCOME_MSG                         MACHINE_NAME _UxGT(" Sẵn sàng.")
#endif
#ifndef MSG_BACK
  #define MSG_BACK                            _UxGT("Back")
#endif
#ifndef MSG_SD_INSERTED
  #define MSG_SD_INSERTED                     _UxGT("Cắm thẻ nhớ")
#endif
#ifndef MSG_SD_REMOVED
  #define MSG_SD_REMOVED                      _UxGT("Đã tháo thẻ nhớ")
#endif
  ...
  #define MSG_AUTO_HOME                       _UxGT("Về gốc toạ độ")
#endif
